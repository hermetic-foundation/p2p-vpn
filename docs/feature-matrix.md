...
2. MTU handling deliberately rejects oversized packets, writes local
   ...
   exercises packet-plane datagram paths with selected-MTU probes, but it does
   not implement overlay fragmentation or adaptive probe-search PMTUD.
