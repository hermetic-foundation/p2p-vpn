...
| 3. Before/After Measurements | Sockets, dial/query rates, CPU, RSS | Comparable baseline/current captures, commands, and limitations | Active; workload preflight implemented; offered-rate fidelity under investigation; 0/48 acceptance runs |
