...
| 3. Before/After Measurements | Sockets, dial/query rates, CPU, RSS | Comparable baseline/current captures, commands, and limitations | Active; version 2 pressure preflight validated; matrix execution and aggregation pending; 0/48 acceptance runs |
