...
| Platform validation | All exported VM scenarios have review results at the revisions listed above; Android passes all 68 multi-network checks at `deedd041`. Actual generated-Nix activation remains. Revalidate affected scenarios after further runtime changes; earlier results retain their stated scope. |
