...
| Resource measurement | [Sustained resource review active](sustained-resource-review.md): paired [ten-cycle churn captures](lifecycle-churn-results.md) pass; whole-runtime allocation attribution, multi-network isolation and Android background measurements remain open |
