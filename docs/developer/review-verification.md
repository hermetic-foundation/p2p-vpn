...
| Resource measurement | [Sustained resource review active](sustained-resource-review.md): paired [ten-cycle churn captures](lifecycle-churn-results.md) and [Android five-cycle isolation captures](android-resource-isolation-cycles.md) pass; whole-runtime allocation attribution and Android background review remain open |
