...
| [Runtime allocation baseline](runtime-allocation-review.md) | Two ten-cycle captures; no added post-drop Rust retention after first use; late RSS plateau | First-use allocation owners and connected runtime/transport attribution |
| [Initialization attribution](runtime-initialization-review.md) | Paired ordered controls locate most first-use retention in Tokio initialization; all later stages release net allocations | Exact cache owners and connected runtime/transport attribution |
| [Connected allocation results](connected-allocation-results.md) | Paired full ten-cycle captures; requested allocations rise despite drained work | Connected transport and retained-growth attribution |
| [AutoNAT ownership](autonat-ownership-review.md) | Paired isolated controls/refusals; repeated requests plateau; timer residual attributed separately | Exact daemon attribution and reconnect retention |
...
| [Explicit allocator returns](explicit-return-review.md) | Calibration and two direct fixtures pass; five additional retained owners identified | Remaining 734 bytes / 11 blocks, bounded reclamation and reconnect growth |
| [Epoch reclamation control](epoch-retention-review.md) | Private collectors release fully; paired 32-cycle runs show bounded bag turnover after misleading ten-cycle growth | Full-daemon correspondence, smaller residual owners and final audit |
| [Stopped-process inventory](frozen-inventory-review.md) | Two calibrations and two direct fixtures match native inventory rows exactly | Apply to live reconnect growth; binary-specific layout and coherence limits |
| [Reconnect size inventory](reconnect-inventory-review.md) | Original one-cycle gates pass; 36 coherent samples locate 6479 bytes / 11 blocks of settled growth | Stack ownership of growing buckets and final audit |
| [Reconnect allocating owners](reconnect-owner-review.md) | Selected channel/session-table owners survive settling and all tracked allocations free at teardown | Remaining bucket correspondence, smaller residuals and final audit |
| [Startup bookkeeping traces](startup-table-review.md) | Three direct traces release all selected allocations; explicit sizes distinguish multiple connection/session owners | 2088-byte reconnect bucket unassigned; original acceptance audit pending |
