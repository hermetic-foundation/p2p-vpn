...
| [Graceful reconnect capture](graceful-churn-results.md) | First ten-cycle capture passes; both post-child residuals match the short direct-UDP admission | Independent repetition, live retention and residual ownership |
