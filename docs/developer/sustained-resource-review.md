...
| [Graceful allocation review](graceful-allocation-review.md) | Blocked Linux TUN reader reproduced and corrected; real direct teardown and shared-Rust checks pass | Sustained pressure/reconnect teardown and residual attribution |
