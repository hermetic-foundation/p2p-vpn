...
| [Connected allocation sampler](connected-allocation-review.md) | Feature-only daemon allocator, phase clock correlation, calibrated one-cycle recovery smoke | Both ten-cycle allocation captures and repeated-growth attribution |
