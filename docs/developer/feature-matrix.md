...
| Android pair and connect | Partial | API 35 persistence, code pairing, dual-stack traffic, and isolated QUIC/TCP streams proven. |
...
| Android remaining paths | Owned QUIC, relay-only, and relay-to-direct scenarios pass separately. |
