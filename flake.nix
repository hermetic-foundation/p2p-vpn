    ...
    // flake-utils.lib.eachSystem supportedSystems (
        ...
        checkOperational = pkgs.writeShellApplication {
          ...
          text = ''
            ...
            vm_checks=(
                          ...
                          ".#checks.$system.nixos-vm-membership-convergence"
          ...
          if androidSupported then
            pkgs.runCommand "p2p-vpn-android-e2e-structure"
              ...
              ''
                ...
                shellcheck ${./tests/android-resource-isolation-state.sh}
                P2P_VPN_ANDROID_RESOURCE_CONTROLS=${./scripts/android-resource-controls.sh} \
                  bash ${./tests/android-resource-isolation-state.sh}
                shellcheck ${./tests/android-resource-permissions.sh}
                shellcheck ${./tests/android-resource-traffic.sh}
                P2P_VPN_ANDROID_E2E_SCRIPT=${./scripts/android-e2e.sh} \
                  bash ${./tests/android-resource-traffic.sh}
                P2P_VPN_ANDROID_E2E_SCRIPT=${./scripts/android-e2e.sh} \
                  bash ${./tests/android-resource-permissions.sh}
      ...
      in
      {
        packages = {
          ...
          releaseArchive =
            pkgs.runCommand "p2p-vpn-0.1.0-${system}.tar.gz"
              {
              ...
              ''
                ...
                cp ${./nix/android.nix} "$release_dir/nix/android.nix"
        ...
        // lib.optionalAttrs androidSupported {
          ...
          android-install = {
            ...
            meta = {
              description = "Install the reproducible p2p-vpn Android debug APK";
            };
          };
          android-update-deps = {
            type = "app";
            program = "${android.androidUpdateDeps}/bin/p2p-vpn-android-update-deps";
            meta = {
              description = "Refresh the pinned Android Gradle dependency cache";
            };
          };
        }
        // lib.optionalAttrs pkgs.stdenv.hostPlatform.isLinux {
        ...
        // lib.optionalAttrs pkgs.stdenv.hostPlatform.isLinux {
          ...
          nixos-consumer-flake =
            pkgs.runCommand "p2p-vpn-nixos-consumer-flake"
              ...
              '';
          nixos-module =
            pkgs.runCommand "p2p-vpn-nixos-module"
              {
                nativeBuildInputs = [ pkgs.jq ];
                ...
                runtimeDirectoryMode =
                  moduleEval.config.systemd.services.p2p-vpn-node-a.serviceConfig.RuntimeDirectoryMode;
                ...
                systemCallArchitectures =
                  moduleEval.config.systemd.services.p2p-vpn-node-a.serviceConfig.SystemCallArchitectures;
          ...
          nixos-vm-membership-convergence = nixosVmMembershipConvergence;
          ...
          public-relay-repro-structure =
            pkgs.runCommand "p2p-vpn-public-relay-repro-structure"
              {
                nativeBuildInputs = [
                  publicRelayRepro
                ];
          ...
          debug-bundle-structure =
            pkgs.runCommand "p2p-vpn-debug-bundle-structure"
              {
                nativeBuildInputs = [
                  debugBundle
                  pkgs.jq
              ...
              ''
                ...
                touch $out
              '';
          public-vpn-repro-structure =
            pkgs.runCommand "p2p-vpn-public-vpn-repro-structure"
              {
                nativeBuildInputs = [
                  package
                  publicVpnRepro
              ...
              ''
                ...
                touch $out
              '';
          public-vpn-repro-evidence-structure =
            pkgs.runCommand "p2p-vpn-public-vpn-repro-evidence-structure"
              {
                nativeBuildInputs = [
                  package
                  publicVpnRepro
              ...
              ''
                ...
                EOF
                            ...
                            touch $out
              '';
          public-vpn-capture-structure =
            pkgs.runCommand "p2p-vpn-public-vpn-capture-structure"
              {
                nativeBuildInputs = [
                  package
                  publicVpnCapture
              ...
              '';
          public-vpn-evidence-check =
            pkgs.runCommand "p2p-vpn-public-vpn-evidence-check"
              {
                nativeBuildInputs = [
                  publicVpnEvidenceCheck
                  pkgs.jq
              ...
              '';
          public-vpn-move-evidence-check =
            pkgs.runCommand "p2p-vpn-public-vpn-move-evidence-check"
              {
                nativeBuildInputs = [
        ...
        // lib.optionalAttrs androidSupported {
          android = android.androidDevShell;
        };
      }
    );
}
